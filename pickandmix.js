...
const pageVersion = document.getElementById("jsCall").getAttribute("calledby")
...
var ignoreCodes = ['4918ca92-426e-443f-9de8-c3d5105ed5a2','e45790e6-d881-423e-b27f-bafb620d17c2','800cd4f3-2dd6-4e55-bce6-0dc6b07a48b6','c4b21ae3-7267-4459-a93f-8482165ae4db', 'ff172108-f4bc-489f-93f6-7ac086dd3cbf'] //Summer challenge achievements and Back To School welcome variant
...
function populate(){
        ...
        Object.keys(libObject).forEach(p => {
            ...
            switch (true){
                ...
                if (!(s.sticker_name.includes("CPD") || s.tags.includes("SB_SC_Achievements"))){
                    ...
                    achLibrary.push(s);}}
                    break;
                case (s.sticker_id == 'da864fa3-7d90-4405-bc44-de7c3287df91' || s.sticker_id == 'ff0c8529-d353-430c-b2a1-7b993c57aaa2'): //Welcome and refer sticker
                    achLibrary.push(s);
                    break;
    ...
    if (pageVersion == "pickandmix"){
        ...
        buildTable(mainTable, mainLibrary, "main", "Our content", "Select the stickers you want to include in your library. Once we've assembled it we will be in touch to set the order for the content.");
    }
    ...
    if (pageVersion == "pickandmix"){
        ...
        if (pageVersion == "scorm"){
            var players = document.getElementsByClassName('videoplayer')
